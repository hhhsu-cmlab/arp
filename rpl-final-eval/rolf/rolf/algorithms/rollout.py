...
class RolloutRunner(object):
    ...
    def run_episode(self, record_video=False):
        ...
        while not done:
            ob, state = ob_next, state_next
            batch = {
                "state_ee_position": [ob_next['robot_state']['ee_pos']],
                "state_ee_quaternion": [ob_next['robot_state']['ee_quat']],
                "state_ee_velocity": [ob_next['robot_state']['ee_pos_vel']],
                "state_ee_angular_velocity": [ob_next['robot_state']['ee_ori_vel']],
                "state_joint_positions": [],
                "state_joint_velocities": [],
                "state_joint_torques": [],
                "state_gripper_width": [ob_next['robot_state']['gripper_width']],
                "action_ee_delta_position": [],
                "action_ee_delta_quaternion": [],
                "action_gripper_range": [],
                "wrist_camera_rgb": [ob['color_image1']],
                "front_camera_rgb": [ob['color_image2']]
            }
